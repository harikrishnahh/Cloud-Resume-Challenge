...
## 📁 Repository Structure
    ...
    └── .github/
        └── workflows/
            ...
            └── backend.yml     # Run Python tests + deploy Lambda
...
| Trigger | Pipeline |
|---|---|
| Push to `frontend/` | Upload to S3 → Invalidate CloudFront cache |
| Push to `backend/` | Run pytest → Deploy Lambda to AWS |
...
Deployments are fully automated via GitHub Actions — no manual AWS Console interaction needed after initial setup.
